...
export default class UserSubscriber {
  ...
  @On(events.user.resendVerification)
  public onResendVerification({ username, email, _id }: Partial<IUser>) {
    const Logger: Logger = Container.get('logger');
    ...
    try {
      ...
      Logger.error(`🔥 Error on event ${events.user.resendVerification}: %o`, e);
